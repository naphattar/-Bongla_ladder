...
public class GuessWhatCard extends BaseCard {

	public GuessWhatCard(float ratePercent) {
		super(ratePercent, "What is your favorite number?");
	...
	public void cardAction(Counter counter) {
		...
		alert.setContentText("choose a number and roll.If correct, u got another card.");
